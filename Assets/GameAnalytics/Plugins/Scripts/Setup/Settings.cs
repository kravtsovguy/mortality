...
namespace GameAnalyticsSDK.Setup
{
	...
	public class Studio
	{
		...
		//[SerializeField]
		public List<GameGA> Games { get; private set; }

		public Studio(string name, string id, List<GameGA> games)
		{
			Name = name;
			ID = id;
			Games = games;
	...
	public class GameGA
	{
		...
		public GameGA(string name, int id, string gameKey, string secretKey)
		{
			Name = name;
			ID = id;
			GameKey = gameKey;
